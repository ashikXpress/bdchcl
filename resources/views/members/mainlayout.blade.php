                                        ...
                                        <a href="#" class="border-gray">
                                            <div class="pull-left">
                                                <img src="{{ asset('backend/assets/dist/img/stethescope.png') }}"
                                                     class="img-thumbnail" alt="User Image"></div>
                                            <h4>stethescope</h4>
    ...
    <aside class="main-sidebar">
        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="">
                        <i class="fa fa-user-circle-o"></i><span>Sales</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                            </span>
                    </a>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-list-alt"></i> <span>News and Events</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
...
<!--==============================================================================
    ...
    <footer class="main-footer">
        <div class="pull-right hidden-xs"><b>Developed By <a href="https://www.facebook.com/jasim.dipu">Md Jasim
                    Uddin</a></b> 01719007880
        </div>
        <strong>Copyright &copy; 2019 <a href="#">Bangladesh Community Health Care Ltd.</a>.</strong> All rights
        reserved.
    </footer>
</div> <!-- ./wrapper -->
<!-- Start Core Plugins
