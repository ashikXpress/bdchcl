                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                            <form class="col-sm-6" action="{{ route('area.store') }}" method="post">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label>Area Id</label>
                                    <input type="text" class="form-control" placeholder="Enter Area ID*" name="area_id" value="{{ old('area_id') }}">
                                </div>
                                <div class="form-group">
                                    <label>Area Name</label>
                                    <input type="text" class="form-control" placeholder="Enter Area Name*" name="area_name" value="{{ old('area_name') }}">
                                </div>
                                <div class="form-group">
