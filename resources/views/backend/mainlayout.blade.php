            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="#">Create Board of Management</a></li>
                        <li><a href="#">Show Board of Management</a></li>
                        <li><a href="{{ route('key.create') }}">Create Key</a></li>
                        <li><a href="{{ route('key.list') }}">Show Key List</a></li>
                        <li><a href="#">Company HCP</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="widgets.html">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{ route('emp.add') }}">Add Employee</a></li>
                        <li><a href="{{ route('emp.list') }}">Employee list</a></li>
                        <li><a href="{{ route('position.add') }}">Add Position</a></li>
                        <li><a href="{{ route('position.list') }}">Position list</a></li>
                        <li><a href="#">Add BCHCL Office</a></li>
                        <li><a href="#">BCHCL Office list</a></li>
                        <li><a href="#">Add Notice</a></li>
                        <li><a href="#">Notice list</a></li>
                        <li><a href="#">Add Event</a></li>
                        <li><a href="#">Event list</a></li>
                        <li><a href="#">Empolyee Recruit</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-credit-card-alt"></i><span>Accounts</span>
                        <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                                </span>
                    </a>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-user"></i><span>Distribution</span>
                        <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{ route('area.add') }}">Add Area</a></li>
                        <li><a href="{{ route('area.list') }}">Area list</a></li>
                        <li><a href="{{ route('dealer.add') }}">Add Dealer</a></li>
                        <li><a href="{{ route('dealer.list') }}">Dealer list</a></li>
                        <li><a href="{{ route('depo.add') }}">Add Depo</a></li>
                        <li><a href="{{ route('depo.list') }}">Depo list</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ route('team.create') }}">Team Setup</a></li>
                        <li><a href="{{ route('team.list') }}">Team List</a></li>
                        <li><a href="{{ route('sales.create') }}">Manage Sales</a></li>
                        <li><a href="{{ route('sales.list') }}">Sales History</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="#">Payment wise Report</a></li>
                        <li><a href="#">Sells wise Report</a></li>
