                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                            <div class="btn-group">
                                <a class="" href=""> <i class="fa fa-list"></i> Member list</a>
                            </div>
                        </div>
                        <div class="panel-body">
                            <form class="col-sm-6" action="{{ route('member.store') }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="house_no" class="form-control" placeholder="Enter House No"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ref_id" value="{{ old('ref_id') }}" class="form-control"
                                           placeholder="Refer Id">
                                </div>
                                <div class="form-group">
                                    <label>Member Key Id</label><br>
                                    <input type="text" name="key_id" value="{{ old('key_id') }}" class="form-control"
                                           placeholder="Key Id">
                                </div>
                                <div class="form-group">
