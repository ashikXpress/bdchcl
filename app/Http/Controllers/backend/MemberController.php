...
class MemberController extends Controller
{
    ...
    {
        $members = MemberRegistration::select('id', 'uid', 'first_name', 'last_name', 'dob', 'gender', 'house_no', 'village_or_rood_no',
            'post_office', 'sub_district', 'district', 'post_code', 'nid_or_birth_id', 'phone_number',
            'education_qualification', 'occupation', 'email', 'ref_id', 'key_id', 'photo')->paginate(10);

        return view('backend.member.index', compact('members', $members));
    }
    ...
    public function employeeSales($emp_id, $ach_member, $ach_hcp, $due_hcp, $commission)
    {
