                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                            <form class="col-sm-6" action="{{ route('dealer.update', $dealer_edit->id) }}" method="post">
